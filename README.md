...
* [`src/canvas/`](src/canvas/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/canvas/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `canvas` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/canvas/config.cljs) defaults to `true` in
...
```clj
(ns canvas.example
  (:require [canvas.config :as config])
